...
class myButtonConnectedAgent(buttonModel: ButtonModel)(val cmd: String) extends NetlogoButtonAgent(buttonModel)()() with Simple {
  
  override def setup = {}
  override def buttonPressedHandle = {}//netlogo_actor ! cmd
...
object ButtonConnectedNetlogo extends App {
  ...
  val myButton1 = system.actorOf(Props(new myButtonConnectedAgent(buttonModel1)(cmd1)), "myButton1")
  val myButton2 = system.actorOf(Props(new myButtonConnectedAgent(buttonModel2)(cmd2)), "myButton2")
